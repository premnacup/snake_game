...
public class MainMenu extends JPanel {
    ...
    private final Font TitleFont = FontLoader.loadFont("..\\Font\\FC Candy.ttf", 72);
    private final Font ButtonFont = FontLoader.loadFont("..\\Font\\FC Candy.ttf", 48);

    public MainMenu(JFrame frame) {
        background = new ImageComponent("..\\Assets\\background.png", SCREEN_WIDTH,
                SCREEN_HEIGHT);
